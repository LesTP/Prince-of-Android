...
**Project phase:** Module 16 — Rendering (Track B). Phase 16a (scaffold) complete, Phase 16b (asset pipeline) complete.
...
| 16 | Rendering | seg008 + lighting → Android | Build + Refine | Game Loop | **In Progress** (Phase 16b complete) |
