...
Update DEVPLAN with the phase plan. Commit the plan.

Under autonomous execution: proceed without waiting for human approval. Log planning decisions to DECISIONS.md. Do not write code in this iteration — exit after planning.
